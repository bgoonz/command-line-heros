function UET(o) {
  ...
  this.knownEvents = {
    ...
    login: ["method"],
    page_view: ["page_title", "page_location", "page_path", "rep", "tpp"],
    purchase: [
      "transaction_id",
      "revenue_value",
      "currency",
  ...
  this.loadConfig = function () {
    ...
    o.Ver !== 1
      ? (this.stringExists(o.tagId) &&
          ...
          (o.ti = o.tagId),
        (f = { ti: 0, Ver: 0, tm: 1, Tag: 0, EXT_Data: 0 }))
      : (f = { Ver: 0, tagId: 0, Tag: 0, Sig: 0, EXT_Data: 0 });
    for (i in o)
      f.hasOwnProperty(i) &&
        (this.beaconParams[i] = f[i] === 1 ? encodeURIComponent(o[i]) : o[i]);
    this.beaconParams.mid = this.getUuidV4(!0);
    this.stringExists(o.ti) &&
      ((n = document.createElement("script")),
      (n.src = r + "//" + this.domain + "/p/action/" + o.ti + ".js"),
      (n.type = "text/javascript"),
      (n.async = 1),
      document.head.appendChild(n));
  };
  this.push = function () {
    ...
    n.documentLoaded || i === "set" || i === "consent"
      ? n._push([i, r, u])
      : n.eventPushQueue.push([i, r, u]);
  };
      ...
      if (n[0] === "event") {
        ...
        f === "default"
          ...
          : f === "update" &&
            ...
            this.uetConfig.consent.adStorageAllowed
              ? this.pageLoadDispatch && this.addMsClkId({})
              : (delete this.beaconParams.sid, delete this.beaconParams.vid));
      }
  };
  ...
  this.fireBeaconImg = function (n) {
    ...
    return (
      ...
      (r = n + "&rn=" + i),
      t.setAttribute("alt", ""),
      o.alt && t.setAttribute("alt", o.alt),
  ...
  this.extractMsClkId = function (n) {
    this.stringExists(this.msClkId) ||
      (this.msClkId = this.getQueryParam(n.p, this.msClkIdParamName));
  };
  ...
  this.validateValue = function (n, t, i, r) {
    ...
    return (
      ...
      u > r
        ...
        : this.getDecimalPlaces(u) > i &&
          this.throwError(
            n + " cannot have more than " + i + " decimal places"
          ),
      u
    );
  };
  ...
  this.validateParameterArray = function (n, t) {
    for (var i = 0; i < n.length; i++)
      typeof n[i] == "object" &&
        ((n[i] = this.validateSubparams(n[i], t + ".")),
        (n[i] = this.removeTrailingAmp(this.stringifyToRequest(n[i]))));
    return n.join(",");
  };
    ...
    if (
      ...
      if (
        ...
        r
          ...
          : ((i.event_action = t), (i = this.validateDataObjectNew(n, i))),
        n === this.customEvt)
      ) {
        o = [];
        for (a in i) o.push(a);
        ...
        if (((h = !r && i.hasOwnProperty("page_path")), h)) {
          if (
            ...
            if (
              ((c = this.previousPage.toUpperCase()),
              (e = c.indexOf("%3A%2F%2F")),
              e === -1)
            )
              return;
              ...
              ? ((e += 9),
                ...
                (i.p =
                  l === -1
                    ...
                    : this.previousPage.substring(0, l) + i.page_path))
  ...
  this.addCookieId = function (n, t, i, r, u) {
    ...
    return (this.stringExists(f) ||
      ((s = !1), (f = this.getLocalStorageBackup(r, this.cookieIdMaxLength))),
    u === 0)
      ? (this.stringExists(f) &&
      ...
      : (this.stringExists(f) &&
        ...
        this.setCookie(r, f, u, s, !0, "", this.cookieIdMaxLength),
  ...
  this.fireBeacon = function (n) {
    for (
      var i,
        ...
        u = this.stringifyToRequest(t),
        f = this.removeTrailingAmp(e + u),
        o = [
          "r",
          "el2",
          "ec2",
        ...
        r = 0;
      encodeURI(f).length > this.URLLENGTHLIMIT && o.length > r;
      r++
    )
      ((i = o[r]), i in t) &&
        (r == 0
  ...
  this.fireSendBeacon = function (n) {
    var i = this.combine(this.beaconParams, { evt: n }),
      t = this.removeTrailingAmp(
        this.previewPrefix + this.stringifyToRequest(i)
      );
